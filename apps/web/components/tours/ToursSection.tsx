...
function TourCard({ title, features, price, image, cardNumber }: TourCardItem) {
  const headingSpanStyles = [
    styles.cardHeadingSpan1,
    styles.cardHeadingSpan2,
    styles.cardHeadingSpan3,
  ];
  const cardBackStyles = [styles.cardBack1, styles.cardBack2, styles.cardBack3];
  const cardPictureStyles = [
    styles.cardPicture1,
    styles.cardPicture2,
    styles.cardPicture3,
  ];
  return (
    <div className={`${styles.card}`}>
      <div className={`${styles.cardSide} ${styles.cardFront}`}>
        <div
          className={`${classNames(styles.cardPicture, cardPictureStyles[cardNumber])}`}
        >
          <Image
            alt="tour card image"
            fill
        ...
        <h4 className={`${styles.cardHeading}`}>
          <span
            className={`${classNames(styles.cardHeadingSpan, headingSpanStyles[cardNumber])}`}
          >
            {title}
          </span>
        </h4>
      ...
      <div
        className={`${classNames(styles.cardSide, styles.cardBack, cardBackStyles[cardNumber])}`}
      >
